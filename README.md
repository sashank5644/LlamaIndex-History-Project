...
To build the system, the LlamaIndex framework was used along with a local large language model (LLM) from Ollama LLMs. To collect the data and transform it into documents, and embed the information
the LlamaIndex tools were used such as SimpleDirectoryReader, and VectorStoreIndex. 
